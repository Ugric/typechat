    ...
    <div>
      ...
      <div className="BlastMenu">
        ...
        >
          ...
          <h3>
            GBP £{((price * (1 - sale)) / 100).toFixed(2)} / Rocket Fuel{" "}
            <img src={fuelIcon} height="35px" alt="⛽" />
          </h3>
          {sale ? (
            <h4>
              {sale * 100}% off <img src={meteorites} height="35px" alt="☄" />
            </h4>
          ) : (
            <></>
          )}
          ...
          >
            ...
            >
              ...
              <li>
                ...
                <img src={fuelIcon} height="15px" alt="⛽" /> set that month)
              </li>
